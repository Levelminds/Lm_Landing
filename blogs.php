...
function blogDecodeHtml($value)
{
    ...
    return html_entity_decode((string) $value, ENT_QUOTES | $html5Flag, 'UTF-8');
}

function blogPlainText($value)
{
    $decoded = blogDecodeHtml($value);
        ...
        <div class="col-lg-7">
          ...
          <?php else: ?>
            <?php
              ...
              $featuredSummaryPlain = blogPlainText($featuredSummaryRaw);
              $featuredSummaryHtml = blogDecodeHtml($featuredSummaryRaw);
              $featuredShareUrl = buildBlogShareUrl($featuredId);
              $featuredShareSummary = $featuredSummaryPlain !== '' ? $featuredSummaryPlain : blogPlainText($featuredContentRaw);
            ...
            <article class="hero-feature">
              ...
              <div class="hero-feature-body">
                ...
                <div class="lead text-muted mb-0"><?php echo $featuredSummaryHtml; ?></div>
        ...
        <?php foreach ($orderedCategories as $categoryKey): ?>
          ...
          <?php foreach ($groupedPosts[$categoryKey] as $post): ?>
            <?php
              ...
              $postSummaryPlain = blogPlainText($postSummary);
              $postSummaryHtml = blogDecodeHtml($postSummary);
              $postShareUrl = buildBlogShareUrl($postId);
              $postShareSummary = $postSummaryPlain !== '' ? $postSummaryPlain : blogPlainText($postContentRaw);
            ...
            <div class="col-xl-4 col-md-6" data-blog-card data-category="<?php echo blogEscapeAttr($categoryKey); ?>">
              <article class="blog-card h-100 d-flex flex-column">
                ...
                <div class="blog-card__body">
                  ...
                  <div class="blog-card__summary mb-0"><?php echo $postSummaryHtml; ?></div>
